import { Children, createContext, useMemo, useReducer, type ReactElement } from "react"
...
const useCartContext = (initCartState: CartStateType) => {
    ...
    const totalPrice: number = new Intl.NumberFormat('en-US', {style: 'currency', currency:'USD'}).format(state.cart.reduce((previousValue,cartItem) => {
